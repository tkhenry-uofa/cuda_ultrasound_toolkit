...
namespace data_conversion
{
    ...
    public:
        ...
        bool convert_i16(const int16_t* d_input, float2* d_output, uint2 input_dims, uint3 output_dims);
        bool convert_f32(const float* d_input, float2* d_output, uint2 input_dims, uint3 output_dims);
