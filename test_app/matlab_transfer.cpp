...
{
	*bp_full = _open_shared_memory_area(PIPE_INPUT_NAME, sizeof(BeamformerParametersFull));

	return true;
}
bool matlab_transfer::wait_for_data(BeamformerParameters* bp, void* pipe, i16* data))
{
	return true;
}
