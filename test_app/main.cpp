...
bool test_beamforming()
{
	...
	std::string output_file_path = R"(C:\Users\tkhen\OneDrive\Documents\MATLAB\lab\vrs_transfers\beamform_hero_output.mat)";
	...
	params.vol_mins[0] = -0.005f;
	params.vol_maxes[0] = 0.005f;
